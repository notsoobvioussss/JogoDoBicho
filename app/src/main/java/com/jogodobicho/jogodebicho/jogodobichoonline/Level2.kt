...
class Level2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        image3 = findViewById(R.id.image32)
        image4 = findViewById(R.id.image42)

        zone1 = findViewById(R.id.zone12)
        zone2 = findViewById(R.id.zone22)
        zone3 = findViewById(R.id.zone32)
        zone4 = findViewById(R.id.zone42)
        ...
        val ne1 = findViewById<ImageView>(R.id.ne2)
        val pr1 = findViewById<ImageView>(R.id.pr2)
        val back1 = findViewById<ImageView>(R.id.back2)
