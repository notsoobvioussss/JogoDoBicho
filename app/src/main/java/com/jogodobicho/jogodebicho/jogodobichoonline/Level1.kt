...
class Level1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        image2 = findViewById(R.id.image21)
        image3 = findViewById(R.id.image31)
        image4 = findViewById(R.id.image41)

        zone1 = findViewById(R.id.zone11)
        zone2 = findViewById(R.id.zone21)
        zone3 = findViewById(R.id.zone31)
        zone4 = findViewById(R.id.zone41)
        ...
        val ne1 = findViewById<ImageView>(R.id.ne1)
        val pr1 = findViewById<ImageView>(R.id.pr1)
