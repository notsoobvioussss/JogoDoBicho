...
class Level4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        image1 = findViewById(R.id.image14)
        image2 = findViewById(R.id.image24)
        image3 = findViewById(R.id.image34)
        image4 = findViewById(R.id.image44)

        zone1 = findViewById(R.id.zone14)
        zone2 = findViewById(R.id.zone24)
        zone3 = findViewById(R.id.zone34)
        zone4 = findViewById(R.id.zone44)
        ...
        val ne1 = findViewById<ImageView>(R.id.ne4)
        val pr1 = findViewById<ImageView>(R.id.pr4)
        val back1 = findViewById<ImageView>(R.id.back4)
